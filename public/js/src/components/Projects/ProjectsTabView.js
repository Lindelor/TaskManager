...
export function getProjectsTabView() {
    ...
    return {
        ...
        columns:[
            ...
            { id:"teamLead", template:"#teamLead.id# #teamLead.lastName# #teamLead.firstName# #teamLead.patronymic#", header:["ТимЛид", {content:"textFilter"}], css:"rank", sort:"string", width:200}
        ],
        data:[], 
    }
