				...
				projectModel.getProjectsNames().then((names) => {
					return (
						...
						body:{
							...
							view:"form", 
							elements:[
								{ view:"text", label:"ID", name:"taskId", value:task.id, disabled:true, labelWidth:120},
								{ view:"textarea", label:"Описание", name:"taskDescription", value:task.description, height: 120, labelWidth:120, disabled:true},
								{ view:"select", label:"Проект", options:names, name:"taskProjectName", value:task.projectName, labelWidth:120, disabled:true},
								{ view:"select", label:"Сотрудник", options:employees, name:"employee", value:task.employee, labelWidth:120, disabled:true},
								{ view:"select", label:"Статус", options:statuses, name:"taskStatus", labelWidth:120, value:task.status, disabled:true},
								{ view:"select", label:"Срочность", options:urgencies, name:"taskUrgency", labelWidth:120, value: task.urgency, disabled:true},
